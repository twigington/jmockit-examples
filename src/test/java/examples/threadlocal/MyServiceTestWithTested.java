...
public class MyServiceTestWithTested {
    ...
    @Test
    public void noThreadLocalMock_otherServiceMock(@Mocked final OtherService otherService) {
    ...
    @Test
    public void dynamicPartialThreadLocalMock_otherServiceMock(@Injectable final OtherService otherService) {
        final String expectedOtherServiceName = "Mock Other Service";
